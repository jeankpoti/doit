...
//     Key? key,
//     required this.stats,
//     this.target = 5, // Example target: 5 tasks per day
//   }) : super(key: key);
...
//     // Here we use the index as the x-value; you could also use the date in milliseconds.
//     final spots = stats.asMap().entries.map((entry) {
//       int index = entry.key;
//       Stats data = entry.value;
//       return FlSpot(index.toDouble(), data.completed.toDouble());
//     }).toList();

//     // Create a horizontal target line.
//     final targetSpots = [
//       FlSpot(0, target.toDouble()),
//       FlSpot(stats.length.toDouble() - 1, target.toDouble()),
//     ];
...
//           ),
//           lineBarsData: [
//             // Main line for daily completed tasks.
//             LineChartBarData(
//               spots: spots,
//               isCurved: true,
//               barWidth: 3,
...
//             ),
//             // Target line for productivity goal.
//             LineChartBarData(
//               spots: targetSpots,
//               isCurved: false,
//               barWidth: 2,
